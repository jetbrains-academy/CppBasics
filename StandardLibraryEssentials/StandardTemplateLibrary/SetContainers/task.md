In addition to all previously covered sequential containers, C++ also provides a number of associative containers. These containers are designed to store elements in a sorted order.
